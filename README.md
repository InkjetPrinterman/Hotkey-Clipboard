...
Unpack ZIP (HotkeyClipboard.zip), open the unpacked folder, and double click the "HotkeyClipboard" Application. 

Highlight text, and press CTRL+ALT+R to begin recording (6 second window) a hotkey with a modifier (CTRL+L, or SHIFT+M for example, whatever you like). 
